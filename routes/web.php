...
Route::prefix('admin')->group(function () {
    ...
    Route::get('customer/listing', [AdminDashboardController::class,'getCustomerListing'])->middleware('auth:admin');
...
Route::prefix('customer')->group(function () {
    ...
    Route::post('logout', [CustomerAuthController::class, 'logout'])->name('customer.logout')->middleware('auth:customer');
...
Route::middleware('auth:admin')->prefix('customer')->group(function () {
    Route::get('/listing', [AdminDashboardController::class, 'getCustomerListing'])->name('customers.index');
});
